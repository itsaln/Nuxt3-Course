...
const search = ref('Tashkent')
const input = ref('')
const background = ref('')

const { data: city, error } = useAsyncData('city', async () => {
	const response = await $fetch(`https://api.openweathermap.org/data/2.5/weather?q=${search.value}&units=metric&appid=bda6a2479c3165876fa7335f499d08c1`)
